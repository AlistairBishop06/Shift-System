...
const worlds: World[] = [
  ...
  },
  {
    ...
    status: "Concept",
    desc: "A zero-gravity scene. Drift between projects sized by star count, orbit a repo to inspect it, follow contribution arcs as comet tails across the void.",
